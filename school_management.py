# first of data downlod.
# Download clone: https://github.com/parmjeetsingh9358?tab=repositories
...
# first of all import all file in your pc...ACTIVE
# like pip install name()
